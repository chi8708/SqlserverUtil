...
SELECT
   ...
   CASE when  c.is_nullable=1 THEN '是' ELSE '否'END AS 是否为空,
    CASE WHEN c.is_identity = 1 THEN '是' ELSE '否' END AS 是否标识,
    CASE WHEN pkc.object_id IS NOT NULL THEN '是' ELSE '否' END AS 是否主键,
